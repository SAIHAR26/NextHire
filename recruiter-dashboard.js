...
const companyProfilePhoneEl = document.getElementById("company-profile-phone");
...
function renderRecruiterDetails(details = {}) {
  ...
  const companyPhone = String(details.companyPhone || localStorage.getItem(COMPANY_PHONE_KEY) || "Not added").trim();
  ...
  if (companyPhone !== "Not added") localStorage.setItem(COMPANY_PHONE_KEY, companyPhone);
  ...
  if (companyPhoneEl) companyPhoneEl.textContent = companyPhone;
  if (companyProfilePhoneEl) companyProfilePhoneEl.textContent = companyPhone;
